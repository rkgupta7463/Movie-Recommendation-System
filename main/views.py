...
Similmodel = decompress_pickle('Similarity.pbz2')
...
def select_poster(movie):
    ...
    recommended_movies_poster.append(fetch_poster(movie_df[movie_df['title']==movie].iloc[0].id))
...
def home(request):
    ...
    selected_value = request.POST.get('movies-name')
